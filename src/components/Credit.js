...
export default class Credit extends React.Component {
    ...
    render() {
        return (
            <div className="credit_back modal show">
                <div className="credit">
                    <div className="credit_header">
                        Credit
                    </div>
...
- Developers-
=========================================================`}    
</pre><pre>{`PDFasT (pdfast@naver.com)
강태욱 (KANG TAE UK)
문용호 (MOON YONG HO)
전가빈 (JEON GA BIN)`}</pre><pre>{`=========================================================
...
Icon made by Katarina Stefanikova from www.flaticon.com
...
`}</pre></pre>                    
                    ...
                    <div className="credit_footer">
                        <button type="button" id="creditCancel" className="btn btn-default"
                        onClick={() => {
                            document.getElementsByClassName("credit_back")[0].style.display = "none";
                        }}
                        >닫기</button>
                    </div>
                </div>                
